...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppGameLevelGameLevelComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(GameLevelComponent, [{
        ...
        key: "initializeMobileButtonsSubscribtion",
        value: function initializeMobileButtonsSubscribtion() {
        ...
        key: "removeMobileButtonsSubscriptions",
        value: function removeMobileButtonsSubscriptions() {
          var btnTop = document.getElementById('btn-top'),
              btnRight = document.getElementById('btn-right'),
              btnLeft = document.getElementById('btn-left'),
              btnBottom = document.getElementById('btn-bottom');
  ...
  function srcAppGameLevelScriptsDrawTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var currentLevel;
    var currentPlayer;
    var defaultMoveVelocity = 0.75;
    var defaultRotateVelocity = 3;
    var textureDim = 64;
