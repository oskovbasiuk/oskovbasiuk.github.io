...
function GameLevelComponent_app_menu_15_Template(rf, ctx) { if (rf & 1) {
    const _r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "app-menu", 14);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("openCloseMenu", function GameLevelComponent_app_menu_15_Template_app_menu_openCloseMenu_0_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3); const ctx_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r2.openCloseMenu($event); })("startLevel", function GameLevelComponent_app_menu_15_Template_app_menu_startLevel_0_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3); const ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r4.startLevel($event); });
...
function GameLevelComponent_app_game_loads_16_Template(rf, ctx) { if (rf & 1) {
    const _r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "app-game-loads", 15);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("openCloseMenu", function GameLevelComponent_app_game_loads_16_Template_app_game_loads_openCloseMenu_0_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6); const ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r5.openCloseMenu($event); })("startLevel", function GameLevelComponent_app_game_loads_16_Template_app_game_loads_startLevel_0_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6); const ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r7.startLevel($event); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
class GameLevelComponent {
    ...
    initializeMobileButtonsSubscribtion() {
        const btnTop = document.getElementById('btn-top'), btnRight = document.getElementById('btn-right'), btnLeft = document.getElementById('btn-left'), btnBottom = document.getElementById('btn-bottom');
        btnTop.addEventListener('touchstart', _scripts_draw__WEBPACK_IMPORTED_MODULE_3__["playerMoveForward"]);
        btnTop.addEventListener('touchend', _scripts_draw__WEBPACK_IMPORTED_MODULE_3__["playerStopMoving"]);
        btnBottom.addEventListener('touchstart', _scripts_draw__WEBPACK_IMPORTED_MODULE_3__["playerMoveBack"]);
        btnBottom.addEventListener('touchend', _scripts_draw__WEBPACK_IMPORTED_MODULE_3__["playerStopMoving"]);
        btnRight.addEventListener('touchstart', _scripts_draw__WEBPACK_IMPORTED_MODULE_3__["playerRotateRight"]);
        btnRight.addEventListener('touchend', _scripts_draw__WEBPACK_IMPORTED_MODULE_3__["playerStopRotating"]);
        btnLeft.addEventListener('touchstart', _scripts_draw__WEBPACK_IMPORTED_MODULE_3__["playerRotateLeft"]);
        btnLeft.addEventListener('touchend', _scripts_draw__WEBPACK_IMPORTED_MODULE_3__["playerStopRotating"]);
    }
    removeMobileButtonsSubscriptions() {
        const btnTop = document.getElementById('btn-top'), btnRight = document.getElementById('btn-right'), btnLeft = document.getElementById('btn-left'), btnBottom = document.getElementById('btn-bottom');
        btnTop.removeEventListener('touchstart', _scripts_draw__WEBPACK_IMPORTED_MODULE_3__["playerMoveForward"]);
        btnTop.removeEventListener('touchmove', _scripts_draw__WEBPACK_IMPORTED_MODULE_3__["playerMoveForward"]);
        btnTop.removeEventListener('touchend', _scripts_draw__WEBPACK_IMPORTED_MODULE_3__["playerStopMoving"]);
        btnBottom.removeEventListener('touchstart', _scripts_draw__WEBPACK_IMPORTED_MODULE_3__["playerMoveBack"]);
        btnBottom.removeEventListener('touchmove', _scripts_draw__WEBPACK_IMPORTED_MODULE_3__["playerMoveBack"]);
        btnBottom.removeEventListener('touchend', _scripts_draw__WEBPACK_IMPORTED_MODULE_3__["playerStopMoving"]);
        btnRight.removeEventListener('touchstart', _scripts_draw__WEBPACK_IMPORTED_MODULE_3__["playerRotateRight"]);
        btnRight.removeEventListener('touchmove', _scripts_draw__WEBPACK_IMPORTED_MODULE_3__["playerRotateRight"]);
        btnRight.removeEventListener('touchend', _scripts_draw__WEBPACK_IMPORTED_MODULE_3__["playerStopRotating"]);
        btnLeft.removeEventListener('touchstart', _scripts_draw__WEBPACK_IMPORTED_MODULE_3__["playerRotateLeft"]);
        btnLeft.removeEventListener('touchmove', _scripts_draw__WEBPACK_IMPORTED_MODULE_3__["playerRotateLeft"]);
        btnLeft.removeEventListener('touchend', _scripts_draw__WEBPACK_IMPORTED_MODULE_3__["playerStopRotating"]);
        btnLeft.removeEventListener('touchcancel', _scripts_draw__WEBPACK_IMPORTED_MODULE_3__["playerStopRotating"]);
    }
}
...
GameLevelComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: GameLevelComponent, selectors: [["app-game-level"]], decls: 18, vars: 5, consts: [["id", "canvas"], ["id", "canvasPlayWindow"], [1, "buttons-layer"], ["color", "primary", "mat-fab", "", "aria-label", "Example icon button with a menu icon", 1, "open-menu-button", 3, "click"], [1, "move-buttons"], [1, "button-pair-wrapper"], ["mat-flat-button", "", "id", "btn-top", 1, "control-button"], ["mat-flat-button", "", "id", "btn-right", 1, "control-button"], ["mat-flat-button", "", "id", "btn-left", 1, "control-button"], ["mat-flat-button", "", "id", "btn-bottom", 1, "control-button"], [1, "timer"], [3, "isAuthorizedUser", "openCloseMenu", "startLevel", 4, "ngIf"], [3, "openCloseMenu", "startLevel", 4, "ngIf"], [3, "levelFinishedEmitter", "finishTime", "startNewLevel"], [3, "isAuthorizedUser", "openCloseMenu", "startLevel"], [3, "openCloseMenu", "startLevel"]], template: function GameLevelComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("startNewLevel", function GameLevelComponent_Template_app_finish_window_startNewLevel_17_listener() { return ctx.startLevel(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } if (rf & 2) {
    ...
    } }, directives: [_angular_material_button__WEBPACK_IMPORTED_MODULE_5__["MatButton"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_6__["MatIcon"], _angular_common__WEBPACK_IMPORTED_MODULE_7__["NgIf"], _finish_window_finish_window_component__WEBPACK_IMPORTED_MODULE_8__["FinishWindowComponent"], _menu_menu_component__WEBPACK_IMPORTED_MODULE_9__["MenuComponent"], _game_loads_game_loads_component__WEBPACK_IMPORTED_MODULE_10__["GameLoadsComponent"]], pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_7__["AsyncPipe"]], styles: ["#canvas[_ngcontent-%COMP%] {\n  width: 15vw;\n  min-width: 200px;\n  position: absolute;\n}\n\n#canvasPlayWindow[_ngcontent-%COMP%] {\n  width: calc(100vw - (100vw - 100%));\n  height: calc(100vh - 4px);\n}\n\n.timer[_ngcontent-%COMP%] {\n  position: absolute;\n  top: 20px;\n  left: 50%;\n  transform: translateX(-50%);\n  color: aqua;\n  font-size: 16px;\n  font-weight: 400px;\n  padding: 5px;\n  background-color: #0002;\n  border-radius: 4px;\n}\n\n.buttons-layer[_ngcontent-%COMP%] {\n  display: none;\n}\n\n@media screen and (max-width: 1200px) {\n  #canvas[_ngcontent-%COMP%] {\n    right: 0;\n  }\n\n  .buttons-layer[_ngcontent-%COMP%] {\n    display: block;\n    position: absolute;\n    top: 0;\n    bottom: 0;\n    right: 0;\n    left: 0;\n  }\n  .buttons-layer[_ngcontent-%COMP%]   .open-menu-button[_ngcontent-%COMP%] {\n    position: absolute;\n    top: 10px;\n    left: 10px;\n    background-color: #0008;\n  }\n  .buttons-layer[_ngcontent-%COMP%]   .move-buttons[_ngcontent-%COMP%] {\n    position: absolute;\n    left: 7vw;\n    bottom: 7vw;\n    width: 15vw;\n    height: 15vw;\n    border-radius: 10%;\n    display: flex;\n    flex-direction: column;\n    justify-content: space-between;\n    transform: rotate(45deg);\n  }\n  .buttons-layer[_ngcontent-%COMP%]   .move-buttons[_ngcontent-%COMP%]   .button-pair-wrapper[_ngcontent-%COMP%] {\n    display: flex;\n    justify-content: space-between;\n    width: 100%;\n    height: 45%;\n  }\n  .buttons-layer[_ngcontent-%COMP%]   .move-buttons[_ngcontent-%COMP%]   .control-button[_ngcontent-%COMP%] {\n    width: 45%;\n    height: 100%;\n    margin: 0;\n    border-radius: 10%;\n    background-color: #0008;\n  }\n  .buttons-layer[_ngcontent-%COMP%]   .move-buttons[_ngcontent-%COMP%]   .control-button.mat-flat-button[_ngcontent-%COMP%] {\n    min-width: 0;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
MenuComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: MenuComponent, selectors: [["app-menu"]], inputs: { isAuthorizedUser: "isAuthorizedUser" }, outputs: { openCloseMenu: "openCloseMenu", startLevel: "startLevel" }, decls: 10, vars: 2, consts: [[1, "modal-background"], [1, "modal-itself"], ["mat-raised-button", "", 1, "modal-button", 3, "click"], ["class", "modal-button", "mat-raised-button", "", 3, "click", 4, "ngIf"]], template: function MenuComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", ctx.isAuthorizedUser);
    } }, directives: [_angular_material_card__WEBPACK_IMPORTED_MODULE_5__["MatCard"], _angular_material_button__WEBPACK_IMPORTED_MODULE_6__["MatButton"], _angular_common__WEBPACK_IMPORTED_MODULE_7__["NgIf"]], styles: [".modal-background[_ngcontent-%COMP%] {\n  width: 100vw;\n  height: 100vh;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  position: absolute;\n  top: 0;\n  left: 0;\n  -webkit-backdrop-filter: blur(10px);\n          backdrop-filter: blur(10px);\n}\n\n.modal-itself[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: space-around;\n}\n\n.modal-itself[_ngcontent-%COMP%]   .modal-button[_ngcontent-%COMP%] {\n  width: 200px;\n  height: 40px;\n}\n\n.modal-itself[_ngcontent-%COMP%]   .modal-button[_ngcontent-%COMP%]:not(:first-child) {\n  margin-top: 16px;\n}\n\n.mat-card[_ngcontent-%COMP%] {\n  padding: 30px;\n  background-color: #444447;\n}\n\n.modal-text[_ngcontent-%COMP%] {\n  color: aqua;\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
